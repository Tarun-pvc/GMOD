...
def normalize_tensor(tensor, min_max = (0,1)):
    ...
    eps = 1e-8
    tensor = (tensor-min_val)*(min_max[1] - min_max[0]) / (max_val - min_val + eps) + min_max[0] 
    return torch.clamp(tensor, min_max[0], min_max[1])
